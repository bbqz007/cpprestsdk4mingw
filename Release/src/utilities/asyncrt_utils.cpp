...
extern "C" {
#endif  /* __cplusplus */
_CRTIMP _locale_t __cdecl z_port_mingw_create_locale(_In_ int _Category, _In_z_ const char * _Locale);
_CRTIMP void __cdecl z_port_mingw_free_locale(_In_opt_ _locale_t _Locale);
#ifdef __cplusplus
}
#endif  /* __cplusplus */
#else
...
#ifdef _WIN32
#ifdef Z_PORT_MINGW
        *clocale = z_port_mingw_create_locale(LC_ALL, "C");
#else
...
#ifdef Z_PORT_MINGW
            z_port_mingw_free_locale(*clocale);
#else
