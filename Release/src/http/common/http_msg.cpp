...
#pragma message("github.com/bbqz007 resolve undefined reference to vtable for")
web::http::details::http_msg_base::~http_msg_base() {}
web::http::details::_http_request::~_http_request() {}
web::http::details::_http_response::~_http_response() {}
web::http::details::_http_response::_http_response() : m_status_code((std::numeric_limits<uint16_t>::max)()) {}
web::http::details::_http_response::_http_response(http::status_code code) : m_status_code(code) {}
#endif
